 ...
 * @param minAmount Minimum trade amount in USDC to be considered a whale trade (default: $5000)
 * @returns Array of whale trades
 */
export async function fetchWhaleTrades(minAmount: number = 5000): Promise<WhaleTrade[]> {
  if (!USE_REAL_API) {
